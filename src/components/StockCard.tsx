    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex gap-2">
            <button 
              ...
              className={`p-2 rounded-full transition-colors ${stock.notificationsEnabled ? 'bg-kawaii-accent1 text-kawaii-dark' : 'bg-gray-100 text-gray-400'}`}
        ...
        {isEditing ? (
          ...
          <div className="flex justify-between items-center text-sm bg-kawaii-bg2 p-3 rounded-2xl border border-kawaii-detail1 mb-4 relative group/limits">
            <div>
              <p className="text-gray-500">Mínimo</p>
              <p className="font-bold">${stock.minLimit.toFixed(2)}</p>
            </div>
            <div className="text-right">
              <p className="text-gray-500">Máximo</p>
              <p className="font-bold">${stock.maxLimit.toFixed(2)}</p>
            </div>
            <button
